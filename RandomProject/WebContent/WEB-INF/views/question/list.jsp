...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <label>试题难度:</label>
            <select id="search-question-diffcult" class="easyui-combobox" panelHeight="auto" style="width:120px">
            	<option value="-1">全部</option>
	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                	<select name="subjectId" class="easyui-combobox easyui-validatebox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择考试课程'">
		                <c:forEach items="${subjectList}" var="subject">
			            	<option value="${subject.id}">${subject.name}</option>
		            	</c:forEach>
		            </select>
            ...
            <tr>
                <td align="right">所属难度:</td>
                <td>
                	<select name="questionDiffcult" class="easyui-combobox easyui-validatebox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择试题难度'">
		                <option value="0">简单</option>
		            	<option value="1">中等</option>
		            	<option value="2">困难</option>
		            </select>
               ...
               <tr>
                <td align="right">所属知识点:</td>
                <td>
                	<select name="questionDistribute" class="easyui-combobox easyui-validatebox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择试题所属知识点'">
            ...
            <tr>
                ...
                <td><input type="text" id="add-optA" name="optA" class="wu-text"></td>
            </tr>
            <tr>
                <td align="right">选项B:</td>
                <td><input type="text" id="add-optB" name="optB" class="wu-text"></td>
            </tr>
            <tr>
                <td align="right">选项C:</td>
                <td><input type="text" id="add-optC" name="optC" class="wu-text" ></td>
            </tr>
            <tr>
                <td align="right">选项D:</td>
                <td><input type="text" id="add-optD" name="optD" class="wu-text" ></td>
            </tr>
            <tr>
        ...
        <table>
           <tr>
            ...
            <tr>
                <td align="right">所属课程:</td>
                <td>
                	<select id="edit-subjectId" name="subjectId" class="easyui-combobox easyui-validatebox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择考试课程'">
		                <c:forEach items="${subjectList}" var="subject">
			            	<option value="${subject.id}">${subject.name}</option>
		            	</c:forEach>
		            </select>
            ...
            <tr>
             ...
             <tr>
                <td align="right">所属难度:</td>
                <td>
                	<select id="edit-questionDiffcult" name="questionDiffcult" class="easyui-combobox easyui-validatebox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择试题类型'">
		                <option value="0">简单</option>
		            	<option value="1">中等</option>
		            	<option value="2">困难</option>
		            </select>
            ...
            <tr>
                <td align="right">选项A:</td>
                <td><input type="text" id="edit-optA" name="optA" class="wu-text"></td>
            </tr>
            <tr>
                <td align="right">选项B:</td>
                <td><input type="text" id="edit-optB" name="optB" class="wu-text"></td>
            </tr>
            <tr>
                <td align="right">选项C:</td>
                <td><input type="text" id="edit-optC" name="optC" class="wu-text" ></td>
            </tr>
            <tr>
                <td align="right">选项D:</td>
                <td><input type="text" id="edit-optD" name="optD" class="wu-text" ></td>
            </tr>
            <tr>
                <td align="right">正确答案:</td>
...
function uploadFile(){
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-optA").val(item.optA);
            	$("#edit-optB").val(item.optB);
            	$("#edit-optC").val(item.optC);
            	$("#edit-optD").val(item.optD);
            	$("#edit-answer").val(item.answer);
            	$("#edit-questionType").combobox('setValue',item.questionType);
            	$("#edit-questionDiffcult").combobox('setValue',item.questionDiffcult);
	...
	*/
	...
	$("#search-btn").click(function(){
		...
		var questionDiffcult = $("#search-question-diffcult").combobox('getValue');
		var subjectId = $("#search-subject").combobox('getValue');
		if(questionType != -1){
			option.questionType = questionType;
		}
		if(questionDiffcult != -1){
			option.questionDiffcult = questionDiffcult;
		}
		if(subjectId != -1){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'questionDiffcult',title:'试题难度',width:100,formatter:function(value,index,row){
				switch(value){
					case 0:return '简单';
					case 1:return '中等';
					case 2:return '困难';
			...
			{ field:'questionDistribute',title:'所属知识点',width:100,formatter:function(value,index,row){
				switch(value){
					case 0:return '综合';
					case 1:return '第一章';
					case 2:return '第二章';
			...
			{ field:'optA',title:'选项A',width:200},
			{ field:'optB',title:'选项B',width:200},
			{ field:'optC',title:'选项C',width:200},
			{ field:'optD',title:'选项D',width:200},
