...
<title>后台管理主页</title>
<link rel="shortcut icon" href="../../resources/admin/easyui/images/favicon.png">
...
<style type="text/css">
.wu-header-left h1,.wu-header-right,.wu-header-right a{
color:#fff;
letter-spacing:5px}
.tabs,.tabs-header{
background:#1772b4;}
...
.panel-header {
    background: -webkit-linear-gradient(top,#d0e7f8 0,#6fbbf3 100%);
    background: -moz-linear-gradient(top,#d0e7f8 0,#6fbbf3 100%);
        background-repeat: repeat;
    background: -o-linear-gradient(top,#d0e7f8 0,#6fbbf3 100%);
    background: linear-gradient(to bottom,#d0e7f8 0,#6fbbf3 100%);
    background-repeat: repeat-x;
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=#d0e7f8,endColorstr=#6fbbf3,GradientType=0);
}
</style>
</head>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
    	<div class="wu-header-left">
        	<h1 style="margin-top: 20px;">随机组卷系统后台管理系统</h1>
        </div>
        <div class="wu-header-right">
        	<p><strong class="easyui-tooltip" title="">${role.name}:${admin.username}</strong>，欢迎您！</p>
            <p><a href="../system/index" target="_blank">网站首页</a>|<a href="#">帮助中心</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	<div class="wu-sidebar" data-options="region:'west',split:true,border:true,title:'后台管理'"> 
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	<c:forEach items="${topMenuList }" var="topMenu">
        	<div title="${topMenu.name }" data-options="iconCls:'${topMenu.icon }'" style="padding:5px;height:initial !important;">  	
