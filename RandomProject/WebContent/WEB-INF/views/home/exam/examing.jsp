...
<div class="main">
	...
	<div class="test_main">
		<div class="nr_left">
											...
											<ul>
													<li class="option" data-type="single" data-value="A">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${sq.question.optA }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="B">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${sq.question.optB }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="C">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_3">
															C.
															<p class="ue" style="display: inline;">${sq.question.optC }</p>
														</label>
													</li>
													...
													<li class="option" data-type="single" data-value="D">
														...
														<label for="${singleQuestion }_answer_${sq.id}_option_4">
															D.
															<p class="ue" style="display: inline;">${sq.question.optD }</p>
														</label>
													</li>
											...
											<ul>
													...
													<li class="option" data-type="muilt" data-value="A">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${mq.question.optA}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="B">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${mq.question.optB}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="C">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_3">
															C.
															<p class="ue" style="display: inline;">${mq.question.optC}</p>
														</label>
													</li>
													...
													<li class="option" data-type="muilt" data-value="D">
														...
														<label for="${muiltQuestion }_answer_${mq.id}_option_4">
															D.
															<p class="ue" style="display: inline;">${mq.question.optD}</p>
														</label>
													</li>
											...
											<ul>
													...
													<li class="option" data-type="charge" data-value="A">
														...
														<label for="${chargeQuestion }_answer_${cq.id}_option_1">
															A.
															<p class="ue" style="display: inline;">${cq.question.optA }</p>
														</label>
													</li>
													...
													<li class="option" data-type="charge" data-value="B">
														...
														<label for="${chargeQuestion }_answer_${cq.id}_option_2">
															B.
															<p class="ue" style="display: inline;">${cq.question.optB }</p>
														</label>
													</li>
											</ul>
										</div>
			...
			<c:if test="${exam.fillsQuestionNum !=0 }">
				<div class="test_content">
					<div class="test_content_title">
						<h2>填空题</h2>
						<p>
							<span>共</span><i class="content_lit">${exam.fillsQuestionNum }</i><span>题，</span><span>合计</span><i class="content_fs">${exam.fillsQuestionNum * fillsScore}</i><span>分</span>
						</p>
						<p style="color:red; font-size:12px;background:transparent;">填空题单题答完后请逐一确认答案，否则不计入分数</p>
					</div>
				</div>
				<div class="test_content_nr">
					
						<c:forEach items="${fillsQuestionList}" var="fq" varStatus="fqids">
							<ul>
								<li class="text_answer_li" style="margin-top:20px" id="qu_${fillsQuestion }_${fq.question.id}" data-key="${fq.id}">
									<div class="test_content_nr_tt">
										<i>${fqids.index+exam.singleQuestionNum+exam.muiltQuestionNum+exam.chargeQuestionNum+1}</i>
										<span>(${fq.question.score}分)</span>
										<font>${fq.question.title }</font>
									</div> 
									 <div id="test11" style="margin-top:5px;" class="test_content_nr_main"> 
										<input style="border:none;border-bottom:1px solid black;outline: none;margin-left:9px;width:480px;" 
										type="text" id="${fillsQuestion }_answer_${fq.id}_option_1" name="fillsquestion"/>
										<input style="" class="btnFills" type="button" value="确定答案"> 
									</div> 
								</li>
					...
					<c:if test="${exam.chargeQuestionNum !=0 }">
						...
						<div class="rt_content">
							<div class="rt_content_tt">
								<h2>填空题</h2>
								<p>
									<span>共</span><i class="content_lit">${exam.fillsQuestionNum }</i><span>题</span>
								</p>
							</div>
							<div class="rt_content_nr answerSheet">
								<ul>
									<c:forEach items="${fillsQuestionList}" var="ffq" varStatus="ffqids">
										<li><a href="#qu_${fillsQuestion}_${ffq.question.id}">${ffqids.index+exam.singleQuestionNum+exam.muiltQuestionNum+exam.chargeQuestionNum+1}</a></li>
									</c:forEach>
								</ul>
							</div>
						</div>
...
$(function() { 
	...
	var selectedAnswer = $(this).prev().val();
	
	$.ajax({
		type: "POST",
		url: "submit_answer",
		dataType: "json",
		data: {"examId":submitExamId,examPaperId:examPaperId,questionId:questionId,
			   answer:selectedAnswer,id:examPaperAnswerId},
...
/* ---------------------------------------------------------------------- */
	...
	$(function() {
		$('li.option input').click(function() {
			...
			var inputAnswer= $(this).closest("li.option").attr("data-value")
			if($(this).closest("li.option").attr("data-type") == 'fills'){
				//如果是填空
				inputAnswer = '';
				var inputBox = $(this).closest("li.option").parent("ul").find("input[type='text']")
				for(var i=0;i<checkedBox.length;i++){
					inputAnswer += $(inputBox[i]).val();
				}
