...
<%@include file="common/header.jsp"%>
	<style>
		...
		.tm_register_container{ width:500px; margin:75px auto; clear:both}
		.tm_register_title{
			height:80px;
    	...
    	<div class="tm_register_form">
            ...
            <table border="0" cellpadding="5" cellspacing="0" class="tm_register_table">
                ...
                <tbody><tr>
                    <th>用户名</th>
                    <td>
						<input type="text" class="validate[required,minSize[11]] tm_txt" name="name" maxlength="30" value="" style="width:200px">
                ...
                <tr>
                    <th>性别</th>
                    <td>
						<select class="validate[required] tm_ssex" name="ssex" style="width:214px;height: 28px;padding: 4px 6px;font-size: 12px;line-height: 28px;color: #555;vertical-align: middle;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;background-color: #fff;border: 1px solid #ccc;">
				...
				<tr>
                    <th>班级信息</th>
                    <td><input type="text" class="tm_txt" name="classinfo" maxlength="30" value="" style="width:200px">
                    <span class="tm_required">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
						<div style="margin-top:40px">
									...
									<button type="button" class="tm_btn tm_btn_primary" style="width:35%" onclick="tm.doRegister();">提交</button>
								
								
							
							
							<button type="button" class="tm_btn" onclick="tm.doGoBack();" style="width:35%">返回</button>
						</div>
                    </td>
                </tr>
                <tr>
	...
	<script type="text/javascript">
		...
		var tm = {
			...
			doRegister : function(){
				...
				var u_ssex = $("select[name='ssex']").val();
				var u_subjectId = $("select[name='subjectId']").val();
				var u_classinfo = $("input[name='classinfo']").val();
				...
				if(baseutil.isEmpty(u_truename)){
					alert('请填写真实姓名');
					return;
				}
				if(baseutil.isEmpty(u_ssex)){
					alert('请填写性别');
					return;
				}
				if(baseutil.isEmpty(u_classinfo)){
					alert('请填写班级信息');
					return;
				}
				...
				$(".tm_btn_primary").text('提交中');
				var tmdata = {
						"name":u_username, "password":u_userpass, 
						"subjectId":u_subjectId, "classinfo":u_classinfo, 
						"trueName":u_truename,"ssex": u_ssex,"t":Math.random()};
