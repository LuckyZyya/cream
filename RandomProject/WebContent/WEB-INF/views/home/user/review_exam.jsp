					...
					<c:if test="${exam.fillsQuestionNum !=0 }">
						<div class="test_content">
							<div class="test_content_title">
								<h2>填空题</h2>
								<p>
									<span>共</span><i class="content_lit">${exam.fillsQuestionNum }</i><span>题，</span><span>合计</span><i class="content_fs">${fillsScore * exam.fillsQuestionNum}</i><span>分</span>
								</p>
							</div>
						</div>
						<div class="test_content_nr">
							<ul>
								<c:forEach items="${fillsQuestionList}" var="fq" varStatus="fqids">
									<li id="qu_${fillsQuestion }_${fq.question.id}" data-key="${fq.id}">
										<div class="test_content_nr_tt">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li  data-type="fills" data-value="${fillsQuestion }_answer_${fq.id}">
														
															<input  class="inputAnswer" type="text"  name="answer${fq.id}"
																id="${fillsQuestion }_answer_${fq.id}" value="${fq.answer}"
															maxlength="0"/>
													...
													<li class="option" data-type="single" data-value="D">
														<label style="color:red;">正确答案：${fq.question.answer }</label>
													</li>
											</ul>
										</div>
									</li>
