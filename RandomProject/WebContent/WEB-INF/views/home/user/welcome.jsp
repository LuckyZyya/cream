...
<%@include file="../common/user_header.jsp"%>
 <link rel="stylesheet" href="../../resources/home/js/Swiper-3.4.2/dist/css/swiper.css">
    <script src="../../resources/home/js/Swiper-3.4.2/dist/js/swiper.js"></script>
    <style>
        .swiper-container {
            width: 100%;
            height: 350px;
		...
		.tm_blocker2{float:left; width:100%;}
</style>
<body>
    ...
    <div class="tm_main" style="min-width:1000px">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image:url(../../resources/home/images/index1.jpg);"></div>
            <div class="swiper-slide" style="background-image:url(../../resources/home/images/index9.jpg);"></div>
        </div>
				...
				var tm = {
					startExam : function(e){
						if(!tmCheckBrowserSupport()){
							alert("抱歉，您的浏览器不被支持，如需继续使用，请更换为：Chrome、Firefox浏览器。");
							return false;
						}
						var tr = $("#"+e);
						...
						html.push('	<p style="line-height:20px;text-align: center;font-size: 16px;">确定开始考试吗？</p>');
						
						html.push('	<table style="margin:0 auto; width:350px" border="0" cellpadding="0" cellspacing="0">');
						html.push('	<tr>');
						html.push('		<td width="150"><img src="../../resources/home/images/paper_pencil.png" width="150"  height="101"/></td>');
						html.push('		<td style="padding-left:35px;"><p><b>考试名称</b>：'+tr.find("td").eq(0).text()+'<p>');
