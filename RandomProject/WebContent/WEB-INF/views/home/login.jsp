                ...
                <tr>
                    ...
                    <td>
						<div style="margin-top:10px">
							<button type="button" class="tm_btn tm_btn_primary" style="width:50%;font-size:14px;" onclick="tm.doLogin();">登&nbsp;录</button>
							<button type="button" class="tm_btn" onclick="tm.goRegister();" style="width:40%;font-size:14px;">注&nbsp;册</button>
						</div>
                    </td>
                </tr>
                <tr>
