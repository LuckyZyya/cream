...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td width="75" align="right">头像预览:</td>
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="/RandomProject/resources/admin/easyui/images/tx.jpg" width="100px">
            ...
            <tr>
                ...
                <td><input type="text" id="add-photo" name="photo" value="/RandomProject/resources/admin/easyui/images/tx.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="75" align="right">所属角色:</td>
                <td>
            ...
            <tr>
                <td width="60" align="right">学院:</td>
                <td><input type="text" name="ugrade" class="wu-text easyui-validatebox" /></td>
            </tr>
        </table>
    </form>
</div>
	...
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="75" align="right">头像预览:</td>
                <td valign="middle">
                	<img id="edit-preview-photo" style="float:left;" src="/RandomProject/resources/admin/easyui/images/tx.jpg" width="100px">
                	<a style="float:left;margin-top:40px;" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/RandomProject/resources/admin/easyui/images/tx.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
            ...
            <tr>
                <td width="60" align="right">学院:</td>
                <td><input type="text" id="edit-ugrade" name="ugrade" class="wu-text easyui-validatebox" /></td>
            </tr>
        </table>
    </form>
</div>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'ugrade',title:'学院',width:200}
		]],
